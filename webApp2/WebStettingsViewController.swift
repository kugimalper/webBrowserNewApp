...
var searchSettings = (searchIsOn: true, searchURL: 2,  selectedSegment: 0, defaultURL: "https://apple.com", tutorial: true)
...
class WebStettingsViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var tutorialSwitchActionOutlet: UISwitch!
    
    @IBAction func tutorialSwitchAction(_ sender: UISwitch) {
        
        if sender.isOn == false {
            searchSettings.tutorial = false
            UserDefaults.standard.set(searchSettings.tutorial, forKey: "Tutorial")
            print (searchSettings.tutorial)
            
        } else {
            searchSettings.tutorial = true
            UserDefaults.standard.set(searchSettings.tutorial, forKey: "Tutorial")
            print (searchSettings.tutorial)
        }
    }
    ...
    override func viewDidLoad() {
        ...
        tutorialSwitchActionOutlet.isOn = searchSettings.tutorial
